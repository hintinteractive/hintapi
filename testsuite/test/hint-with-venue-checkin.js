...
var _c_lat = 23.8347158;
var _c_lng = 90.4351137;
...
//var _u1_social_id = 'Facebook:327495417401768';
var _u1_name = 'user1';

//var _u2_social_id = 'Facebook:1388595761429332';
var _u2_name = 'user2';
    ...
    it('gets a list of nearby venues', function (done) {
        ...
        api.get('/api/venue')
            ...
            .end(function (err, res) {
                ...
                //console.log("venue response :".underline.green, _u1_social_id);
               	done();         
            });
    });
});
